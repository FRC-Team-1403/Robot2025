...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(65).withKI(0).withKD(0)
        .withKS(0.01).withKV(2.62).withKA(0)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(0.1).withKI(0).withKD(0) //kP = 0.16815
        .withKS(0.070382).withKV(0.1131).withKA(0.010184);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.185546875);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.232177734375);
    ...
    public static final double kMaxAngularRate = RotationsPerSecond.of(1.0).in(RadiansPerSecond); // 3/4 of a rotation per second max angular velocity
