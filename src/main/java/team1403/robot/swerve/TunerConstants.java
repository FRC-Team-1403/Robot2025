...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(Swerve.KpSteer).withKI(Swerve.KiSteer).withKD(Swerve.KdSteer)
        .withKS(Swerve.KsSteer).withKV(Swerve.KvSteer).withKA(Swerve.KaSteer)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(Swerve.KpDrive).withKI(Swerve.KiDrive).withKD(Swerve.KdDrive) //kP = 0.16815 //kp= 0.1
        .withKS(Swerve.KsDrive).withKV(Swerve.KvDrive).withKA(Swerve.KaDrive);
    ...
    public static final Distance kWheelRadius = Inches.of(1.925);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.43994140625);
