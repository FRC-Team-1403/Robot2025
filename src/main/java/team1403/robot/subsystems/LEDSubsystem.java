...
public class LEDSubsystem extends SubsystemBase {
    ...
    public void setLEDcolor(LEDConfig.Style style, LEDConfig.Color primary) {
        ...
        switch(style) {
            ...
            case Strobe:
                m_candle.animate(new StrobeAnimation(P_red, P_green, P_blue, 0, 
                                                    m_animSpeed, m_ledCount));
                break;
            case Upwards:
    ...
    public Command requestState(LEDConfig.Style style, LEDConfig.Color color) {
        return runOnce(() -> setLEDcolor(style, color));
    }
